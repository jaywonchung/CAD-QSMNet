...
%---------------------------customize section-----------
DATA_NAME='../../Data/Train_0806_serena.mat';
...
for patientNumber=patientSet
    ...
    for i=1:5
        current_cosmos(:,:,:,i)=1*current_cosmos(:,:,:,i);
        current_phase(:,:,:,i)=ifftn(fftn(current_cosmos(:,:,:,i)).*D);
        current_cosmos(:,:,:,i+5)=0.5*current_cosmos(:,:,:,i);
        current_phase(:,:,:,i+5)=ifftn(fftn(current_cosmos(:,:,:,i)).*D);
        current_cosmos(:,:,:,i+10)=0.25*current_cosmos(:,:,:,i);
        current_phase(:,:,:,i+10)=ifftn(fftn(current_cosmos(:,:,:,i)).*D);
    end
